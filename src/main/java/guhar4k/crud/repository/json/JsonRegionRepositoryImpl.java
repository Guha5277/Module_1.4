...
//        List<Region> regionList = getAll();
//        Region foundRegion = regionList.stream()
//                .filter(r -> r.getId() == region.getId())
//                .findFirst()
//                .orElseThrow(() -> new NoSuchElementException("Repository do not contains record: " + region));
//        int index = regionList.indexOf(foundRegion);
